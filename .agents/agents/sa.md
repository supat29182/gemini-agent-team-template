...
1. ใช้ `view_file` อ่านไฟล์ประวัติความต้องการจาก `second-brain/00-inbox/inbox_log.md` (`[[inbox_log]]`) รายการล่าสุด พร้อมอ่านเอกสารความต้องการธุรกิจจาก `second-brain/10-requirements-spec/brd.md` (`[[brd]]`) และ `second-brain/10-requirements-spec/epics_user_stories.md` (`[[epics_user_stories]]`)
...
5. ในเอกสาร `[[system_spec]]` ให้ระบุการลิงก์ย้อนกลับไปยังเอกสารธุรกิจด้วย Wikilinks (เช่น อ้างอิงจาก `[[brd#หัวข้อ]]` และ `[[epics_user_stories#หัวข้อ]]`)
