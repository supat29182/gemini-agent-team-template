...
3. ออกแบบ Test Scenarios ที่ครอบคลุม Happy Path, Edge Cases, และ Error Cases โดยใช้แนวทางคิดแบบวิเคราะห์ความถูกต้องล่วงหน้าจาก Skill [test-driven-development](../../.agents/skills/test-driven-development/SKILL.md) และการเขียนรูปแบบ Markdown จาก [obsidian-markdown](../../.agents/skills/obsidian-markdown/SKILL.md) ร่วมกับการวางแผนโครงสร้างเคสอย่างเป็นระบบจาก [planning-and-task-breakdown](../../.agents/skills/planning-and-task-breakdown/SKILL.md) แล้วใช้ `write_to_file` เขียนเก็บไว้ที่ไฟล์เฉพาะของฟีเจอร์นี้: `second-brain/50-qa-testing/features/<slug>/test_plan.md` — ต้องมี YAML Frontmatter พร้อม tags ตามนโยบาย
