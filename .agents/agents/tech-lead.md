...
1. ใช้ `view_file` อ่านและศึกษาความต้องการจาก `second-brain/10-requirements-spec/system_spec.md` (`[[system_spec]]`) และ `second-brain/20-architecture/architecture_impact.md` (`[[architecture_impact]]`) เพื่อทำความเข้าใจงานให้ครบถ้วน
