...
1. ใช้ `view_file` อ่านและศึกษาความต้องการจาก `second-brain/10-requirements-spec/system_spec.md` (`[[system_spec]]`), `second-brain/10-requirements-spec/epics_user_stories.md` (`[[epics_user_stories]]`) และ `second-brain/20-architecture/architecture_impact.md` (`[[architecture_impact]]`) เพื่อทำความเข้าใจงานทั้งหมด
...
4. ใช้ `write_to_file` บันทึกแผนการพัฒนาลงใน `second-brain/30-development/dev-plan.md` เพื่อให้ Backend/Frontend Dev ใช้อ้างอิง
