...
1. ใช้ `view_file` อ่านและศึกษาความต้องการทดสอบจาก `second-brain/50-qa-testing/test_plan.md` (`[[test_plan]]`) ให้เข้าใจทุก Test Scenario ก่อนเริ่มรัน
