...
5. **ห้ามใช้ `view_file` หรือ `grep_search` ไล่อ่านโค้ดดิบเพื่อทำความเข้าใจโครงสร้าง** ให้ใช้ tool `nexus-librarian` หรือคำสั่ง `gitnexus_context` ในการสืบค้นหาโครงสร้างหน้าบ้าน (components, pages) ที่เกี่ยวข้องก่อนลงมือเขียนเสมอเพื่อประหยัด Token
...
8. หากมี Build Error, การรันติดขัด, หรือ **กรณีถูกตีกลับงาน (Bug Fix จาก PM)** ให้ดำเนินการดังนี้:
