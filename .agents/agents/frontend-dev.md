...
7. เมื่อ build ผ่าน ให้ทบทวนความเรียบง่ายของโค้ดโดยใช้ [code-simplification](../../.agents/skills/code-simplification/SKILL.md) จากนั้นใช้ `read_file` อ่านเทมเพลตจาก `second-brain/70-resources/templates/template-changelog.md` แล้วใช้ `write_file` สร้างบันทึก changelog ลงใน `second-brain/archives/changelog/YYYY-MM-DD-frontend.md` ระบุไฟล์ที่แก้ไขและเหตุผล
8. ใช้ `write_file` บันทึกสั้นๆ ลงใน `second-brain/diary/YYYY-MM-DD-frontend-dev.md` ว่า UI/UX ที่เขียนครอบคลุมอะไร ผลการ build เป็นอย่างไร
