...
4. **ห้ามใช้ `view_file` หรือ `grep_search` ไล่อ่านโค้ดดิบเพื่อทำความเข้าใจโครงสร้าง** ให้ส่งข้อความถาม tool `nexus-librarian` ในการสืบค้นหาโครงสร้าง API/Functions ที่เกี่ยวข้องก่อนลงมือเขียนเสมอเพื่อประหยัด Token
