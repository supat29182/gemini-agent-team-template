...
5. ใช้ `list_dir` และ `grep_search` สำรวจโค้ด codebase ปัจจุบันในส่วนที่จะแก้ไขก่อนลงมือเพื่อไม่ให้ทับงานเดิม
...
12. รัน Brain Linter: ใช้ `run_command` รันคำสั่ง `python3 scripts/brain_linter.py` เพื่อตรวจสอบความสมบูรณ์และถูกต้องของเอกสารใน Second Brain หากพบ Error ให้แก้ไขให้เรียบร้อยก่อนส่งงาน
