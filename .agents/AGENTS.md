...
*   **ข้อจำกัดสำคัญ (Critical Constraints)**: **ห้าม PM/PO ดำเนินการเขียนหรือแก้ไขโค้ดโปรเจกต์หลัก และห้ามร่างเอกสารข้อกำหนดทางเทคนิค (เช่น system_spec.md, architecture_impact.md) ด้วยตนเองโดยเด็ดขาด** เพื่อรักษากระบวนการสอบทานของ Specialist Agents (sa, solution-architect) ให้สมบูรณ์ PM/PO ทำหน้าที่ได้เพียงการสัมภาษณ์ความต้องการ, ปรับปรุง Inbox/Project Board, และสั่งการ Subagents ตามเฟสเท่านั้น
